...
version: "1.0.0"
description: "Guides users through installing skills, agents, scripts, or references from the agent-skills repo into their global Copilot configuration (~/.copilot/) or a project-based .github/ folder, including automatic dependency resolution and pre-install sync with the latest main branch."
